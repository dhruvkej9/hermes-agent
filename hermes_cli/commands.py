...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("side", "Fork the current session into an ephemeral side conversation", "Session",
               aliases=("fork",), args_hint="[prompt]"),
    CommandDef("sidereturn", "Return from the current side conversation to the parent session", "Session",
